 ...
 */
const text = new StringWorker("Η καριέρα μου στο Water Park Simulator ήρθε η ώρα να εκτοξευτεί. Το όραμά μου θα πραγματοποιηθεί. Δείτε πώς απλά βάφτε. Εμ πολύ γυαλιστερό είναι. Δεν μ αρέσει.");
/**
